...
def rrr_loss_function(A, X, y, logits, criterion, class_weights, l2_grads=1000, reduce_func=torch.sum):
    ...
    return right_answer_loss + right_reason_loss, right_answer_loss, right_reason_loss
